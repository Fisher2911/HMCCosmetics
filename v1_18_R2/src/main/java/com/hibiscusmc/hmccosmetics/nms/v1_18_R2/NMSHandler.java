...
public class NMSHandler implements com.hibiscusmc.hmccosmetics.nms.NMSHandler {
    ...
    @Override
    public @Nullable PacketEntity getEntity(int entityId) {
...
//    }
    ...
    @Override
    public PacketArmorStand getHMCArmorStand(Location loc) {
...
//        return hmcArmorStand.getBukkitEntity();
    ...
    @Override
    public PacketParticleCloud spawnHMCParticleCloud(Location location) {
